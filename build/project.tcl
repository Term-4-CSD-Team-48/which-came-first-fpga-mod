...
set verilogSources [list "./source/alchitry_top.sv" "./source/reset_conditioner.sv" "./source/decimal_counter.sv" "./source/multi_decimal_counter.sv" "./source/multi_seven_seg.sv" "./source/counter.sv" "./source/decoder.sv" "./source/seven_seg.sv" "./source/edge_detector.sv" "./source/which_came_first.sv" "./source/pipeline.sv" "./source/button_conditioner.sv" "./source/lucid_globals.sv" ]
